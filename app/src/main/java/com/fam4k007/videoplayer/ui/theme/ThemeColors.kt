...
val BluePurpleThemeColors = ThemeColors(
    ...
    background = Color(0xFF0A0F1F),           // 极深蓝背景（接近黑色带蓝调）
...
val GreenThemeColors = ThemeColors(
    ...
    background = Color(0xFF0A1F0F),           // 极深绿背景
...
val OrangeThemeColors = ThemeColors(
    ...
    background = Color(0xFF1F0F0A),           // 极深橙背景
...
val PinkThemeColors = ThemeColors(
    ...
    background = Color(0xFF1F0A14),           // 极深粉背景
...
val IndigoThemeColors = ThemeColors(
    ...
    background = Color(0xFF0A0F1A),           // 极深靛蓝背景
