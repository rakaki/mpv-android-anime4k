...
| 主页 | 视频列表与排序 | 播放历史 | 设置页 |
|------|--------------|---------|--------|
| ![主页](docs/screenshots/主页.jpg) | ![视频列表](docs/screenshots/排序功能与视频列表.jpg) | ![播放历史](docs/screenshots/播放历史.jpg) | ![设置页](docs/screenshots/设置页.jpg) |

### 播放器界面（横屏）

| 弹幕功能 | 弹幕样式设置 |
|---------|------------|
| ![弹幕功能](docs/screenshots/弹幕功能.jpg) | ![弹幕样式](docs/screenshots/弹幕样式设置.jpg) |

| 字幕样式设置 | 超分功能 |
|------------|---------|
| ![字幕样式](docs/screenshots/字幕样式设置.jpg) | ![超分功能](docs/screenshots/超分功能.jpg) |
...
由于 AI 生成的特殊性，项目中可能存在代码冗余或不够精简的情况，感谢理解。另外，如果您是个人开发者，有一定的开发经验，并且有自己的代码风格，我非常非常非常不建议您通过“人工”的形式尝试去解析代码结构与工作逻辑，这会使你抓狂（举例:在对弹幕功能进行重构时，AI都忍不住直呼天哪！）。虽然我此前已经进行过一次大优化，对大部分代码进行了归类与重构，但还是不能排除代码中有大量存在但已经注释掉的废弃代码，这部分还需要等待后期的优化。建议您使用AI来分析代码结构，感谢您的理解！
